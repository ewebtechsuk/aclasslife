				...
				<div class="barn2-inside-wrapper">
					<?php if ( $active_tab === 'general' ) : ?>
						...
						<form action="options.php" method="post">
							<?php
							settings_errors();
							settings_fields( $setting_tabs[ $active_tab ]::OPTION_GROUP );
							do_settings_sections( $setting_tabs[ $active_tab ]::MENU_SLUG );
							?>
					...
					<?php else : ?>
						...
						if ( isset( $setting_tabs[ $active_tab ] ) ) {
							echo $setting_tabs[ $active_tab ]->output(); //phpcs:ignore
						} else {
